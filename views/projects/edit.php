...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo BASE_URL; ?>/projects.php?action=update" method="post" data-validate>
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?php echo BASE_URL; ?>/projects.php" class="btn btn-secondary">Annuler</a>
                    </div>
                </form>
            </div>
        </div>
