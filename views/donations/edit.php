...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <a href="<?php echo BASE_URL; ?>/donations.php" class="btn btn-secondary">Retour à la liste</a>
</div>
...
<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form action="<?php echo BASE_URL; ?>/donations.php?action=update" method="post" data-validate>
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?php echo BASE_URL; ?>/donations.php" class="btn btn-secondary">Annuler</a>
                    </div>
                </form>
            </div>
        </div>
