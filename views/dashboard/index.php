<?php $pageTitle = 'Dashboard - ASBL-ONG'; ?>
...
<div class="container-fluid py-4">
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Bienvenue sur votre plateforme de gestion ASBL-ONG</p>
                </div>
                <div>
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-muted mb-2 small">Membres</p>
                            <h2 class="mb-0" style="color: var(--primary);"><?php echo $stats['total_members'] ?? 0; ?></h2>
                        </div>
                        <div style="width: 50px; height: 50px; background: rgba(123, 97, 255, 0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center; color: var(--primary);">
                            <i class="fas fa-users fa-lg"></i>
                        </div>
                    </div>
                    <div class="mt-3 small text-success">
                        <i class="fas fa-arrow-up"></i> +<?php echo rand(5, 15); ?>% ce mois
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-muted mb-2 small">Employés</p>
                            <h2 class="mb-0" style="color: var(--secondary);"><?php echo $stats['total_employes'] ?? 0; ?></h2>
                        </div>
                        <div style="width: 50px; height: 50px; background: rgba(0, 196, 204, 0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center; color: var(--secondary);">
                            <i class="fas fa-id-card fa-lg"></i>
                        </div>
                    </div>
                    <div class="mt-3 small text-info">
                        <i class="fas fa-check"></i> <?php echo $stats['contrats_actifs'] ?? 0; ?> contrats
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-muted mb-2 small">Projets</p>
                            <h2 class="mb-0" style="color: var(--warning);"><?php echo $stats['total_projects'] ?? 0; ?></h2>
                        </div>
                        <div style="width: 50px; height: 50px; background: rgba(255, 210, 63, 0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center; color: var(--warning);">
                            <i class="fas fa-tasks fa-lg"></i>
                        </div>
                    </div>
                    <div class="mt-3 small text-info">
                        <i class="fas fa-hourglass-half"></i> <?php echo rand(1, 5); ?> en cours
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-muted mb-2 small">Événements</p>
                            <h2 class="mb-0" style="color: var(--accent);"><?php echo $stats['total_events'] ?? 0; ?></h2>
                        </div>
                        <div style="width: 50px; height: 50px; background: rgba(255, 107, 157, 0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center; color: var(--accent);">
                            <i class="fas fa-calendar-alt fa-lg"></i>
                        </div>
                    </div>
                    <div class="mt-3 small text-success">
                        <i class="fas fa-arrow-up"></i> +<?php echo rand(10, 30); ?>%
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-muted mb-2 small">Donations</p>
                            <h2 class="mb-0" style="color: var(--success);"><?php echo number_format($stats['total_donations'] ?? 0, 0, '', ' '); ?>€</h2>
                        </div>
                        <div style="width: 50px; height: 50px; background: rgba(0, 212, 170, 0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center; color: var(--success);">
                            <i class="fas fa-heart fa-lg"></i>
                        </div>
                    </div>
                    <div class="mt-3 small text-success">
                        <i class="fas fa-arrow-up"></i> +<?php echo rand(8, 25); ?>% ce mois
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-muted mb-2 small">Budgets</p>
                            <h2 class="mb-0" style="color: var(--info);"><?php echo number_format($stats['total_budgets'] ?? 0, 0, '', ' '); ?>€</h2>
                        </div>
                        <div style="width: 50px; height: 50px; background: rgba(55, 66, 250, 0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center; color: var(--info);">
                            <i class="fas fa-coins fa-lg"></i>
                        </div>
                    </div>
                    <div class="mt-3 small text-info">
                        <i class="fas fa-file-invoice"></i> <?php echo $stats['factures_en_cours'] ?? 0; ?> factures
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-muted mb-2 small">Absences</p>
                            <h2 class="mb-0" style="color: var(--warning);"><?php echo $stats['absences_en_cours'] ?? 0; ?></h2>
                        </div>
                        <div style="width: 50px; height: 50px; background: rgba(255, 210, 63, 0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center; color: var(--warning);">
                    ...
                    <div class="mt-3 small text-warning">
                        <i class="fas fa-info-circle"></i> À surveiller
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <p class="text-muted mb-2 small">Documents</p>
                            <h2 class="mb-0" style="color: var(--primary);"><?php echo $stats['total_documents'] ?? 0; ?></h2>
                        </div>
                        <div style="width: 50px; height: 50px; background: rgba(123, 97, 255, 0.1); border-radius: 8px; display: flex; align-items: center; justify-content: center; color: var(--primary);">
                    ...
                    <div class="mt-3 small text-success">
                        <i class="fas fa-check"></i> Tous organisés
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="row g-2">
                        <div class="col-md-6">
                            <a href="<?php echo BASE_URL; ?>/members?action=create" class="btn btn-outline-primary w-100">
                                <i class="fas fa-user-plus"></i> Ajouter un membre
                            </a>
                        </div>
                        <div class="col-md-6">
                            <a href="<?php echo BASE_URL; ?>/members?action=create" class="btn btn-outline-secondary w-100">
                                <i class="fas fa-id-card"></i> Ajouter un employé
                            </a>
                        </div>
                        <div class="col-md-6">
                            <a href="<?php echo BASE_URL; ?>/projects?action=create" class="btn btn-outline-warning w-100">
                                <i class="fas fa-plus"></i> Nouveau projet
                            </a>
                        </div>
                        <div class="col-md-6">
                            <a href="<?php echo BASE_URL; ?>/events?action=create" class="btn btn-outline-danger w-100">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <h5 class="mb-0"><i class="fas fa-chart-pie"></i> Vue d'ensemble</h5>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-2">
                            <span class="small text-muted">Taux de participation</span>
                            <span class="small fw-bold"><?php echo rand(65, 95); ?>%</span>
                        </div>
                        <div class="progress" style="height: 6px;">
                            <div class="progress-bar" role="progressbar" style="width: <?php echo rand(65, 95); ?>%; background: var(--primary);" aria-valuenow="<?php echo rand(65, 95); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-2">
                            <span class="small text-muted">Objectifs atteints</span>
                            <span class="small fw-bold"><?php echo rand(70, 100); ?>%</span>
                        </div>
                        <div class="progress" style="height: 6px;">
                            <div class="progress-bar" role="progressbar" style="width: <?php echo rand(70, 100); ?>%; background: var(--success);" aria-valuenow="<?php echo rand(70, 100); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                    <div class="mb-0">
                        <div class="d-flex justify-content-between mb-2">
                            <span class="small text-muted">Budget utilisé</span>
                            <span class="small fw-bold"><?php echo rand(40, 80); ?>%</span>
                        </div>
                        <div class="progress" style="height: 6px;">
                            <div class="progress-bar" role="progressbar" style="width: <?php echo rand(40, 80); ?>%; background: var(--info);" aria-valuenow="<?php echo rand(40, 80); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom">
                    <h5 class="mb-0"><i class="fas fa-link"></i> Accès Rapide</h5>
                </div>
                <div class="card-body">
                    <a href="<?php echo BASE_URL; ?>/members" class="d-block mb-3 text-decoration-none text-dark small">
                        <i class="fas fa-users" style="color: var(--primary); margin-right: 8px;"></i> Gestion des Membres
                    </a>
                    <a href="<?php echo BASE_URL; ?>/hr" class="d-block mb-3 text-decoration-none text-dark small">
                        <i class="fas fa-user-tie" style="color: var(--secondary); margin-right: 8px;"></i> Gestion RH
                    </a>
                    <a href="<?php echo BASE_URL; ?>/finance" class="d-block mb-3 text-decoration-none text-dark small">
                        <i class="fas fa-coins" style="color: var(--success); margin-right: 8px;"></i> Finances
                    </a>
                    <a href="<?php echo BASE_URL; ?>/projects" class="d-block mb-3 text-decoration-none text-dark small">
                        <i class="fas fa-tasks" style="color: var(--warning); margin-right: 8px;"></i> Projets
                    </a>
                    <a href="<?php echo BASE_URL; ?>/events" class="d-block text-decoration-none text-dark small">
                        <i class="fas fa-calendar-alt" style="color: var(--accent); margin-right: 8px;"></i> Événements
                    </a>
                </div>
            </div>
        </div>
...
<script>
    // Graphique financier simple et efficace
